            ...
            <div className="flex flex-col justify-center space-y-6 text-white">
              <div className="space-y-4">
                ...
                <p className="max-w-[600px] text-white md:text-xl font-medium">
                  Soluções personalizadas e de alta qualidade para atender às necessidades dos nossos clientes.
                </p>
              </div>
              <div className="flex flex-col gap-4 min-[400px]:flex-row pt-2">
                <Button size="lg" variant="secondary" asChild className="font-bold text-black shadow-md hover:shadow-lg transition-shadow">
                  <Link href="/contato">Solicite um Orçamento</Link>
                </Button>
                <Button size="lg" variant="outline" className="bg-white text-primary font-bold shadow-md hover:shadow-lg transition-shadow" asChild>
        ...
        <div className="container px-6 md:px-8">
          <div className="flex flex-col items-center justify-center space-y-6 text-center">
            <div className="space-y-3">
              <h2 className="text-3xl font-bold tracking-tight sm:text-5xl text-black">Nossos Serviços</h2>
          ...
          <div className="grid gap-8 mt-16 md:grid-cols-2 lg:grid-cols-3">
            <Card className="border-2 border-primary shadow-md hover:shadow-lg transition-shadow">
              <CardContent className="p-8 space-y-3">
                <h3 className="text-2xl font-bold text-black">Walk-in Cooler</h3>
                <p className="text-black">Projetos e instalação de câmaras frigoríficas personalizadas</p>
              </CardContent>
            </Card>
            <Card className="border-2 border-primary shadow-md hover:shadow-lg transition-shadow">
              <CardContent className="p-8 space-y-3">
                <h3 className="text-2xl font-bold text-black">Balcões Refrigerados</h3>
        ...
        <div className="container px-6 md:px-8">
          <div className="grid gap-12 md:gap-16 md:grid-cols-2">
            <div className="space-y-6">
              <div className="inline-block rounded-lg bg-primary px-4 py-2 text-sm text-white font-bold shadow-sm">Nossa História</div>
              ...
              <p className="text-black md:text-lg">
                A Foka Refrigeração foi fundada há mais de 30 anos por Marcio Goulart de Bitencourt, um profissional
                apaixonado por refrigeração industrial.
              </p>
              <div className="space-y-4 pt-2">
                <div className="flex items-center gap-3">
                  <Check className="h-6 w-6 text-primary" />
                  <span className="text-black font-medium">Experiência comprovada no mercado</span>
                </div>
                <div className="flex items-center gap-3">
                  <Check className="h-6 w-6 text-primary" />
                  <span className="text-black font-medium">Atendimento personalizado</span>
                </div>
                <div className="flex items-center gap-3">
                  <Check className="h-6 w-6 text-primary" />
                  <span className="text-black font-medium">Soluções sob medida</span>
                </div>
              </div>
              <Button variant="default" className="mt-6 font-bold shadow-md hover:shadow-lg transition-shadow" asChild>
                <Link href="/sobre">
          ...
          <div className="flex flex-col items-center justify-center space-y-6 text-center">
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[700px] text-white font-medium md:text-xl">
                Estamos prontos para ajudar você com as melhores soluções em refrigeração
              </p>
            </div>
            <div className="grid gap-10 md:grid-cols-3 w-full max-w-3xl mt-6">
              ...
              <div className="flex flex-col items-center space-y-3 p-6 bg-white/10 rounded-lg shadow-lg">
                ...
                <p className="font-medium">Rua Aduci Arbueis do Nascimento 250</p>
              </div>
            </div>
            <Button size="lg" variant="secondary" className="mt-10 font-bold text-black shadow-md hover:shadow-lg transition-shadow" asChild>
              <Link href="/contato">Solicite um Orçamento</Link>
            </Button>
          </div>
        </div>
